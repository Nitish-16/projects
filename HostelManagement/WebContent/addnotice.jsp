...
<body>
	...
	<a href="adminprofile.jsp"><i class="fa fa-fw fa-book"></i>
			AddProfile</a>
			<a class="active" href="addnotice.jsp"><i class="fa fa-fw fa-book"></i>
			AddNotice</a>
		 <a	class="#" href="#"><i class="fa fa-fw fa-book"></i>
			Complaint</a>
	...
	<div class="container">
		...
		<div class="form group">
				<label for="Complaint">Notice</label>
