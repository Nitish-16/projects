...
<%@page import="chitkara.operation.ProfileOperation" %>
<%@page import="chitkara.operation.UserOperation" %>


<%NoticeDao n=(NoticeDao)session.getAttribute("n");%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	<div class="h1">
		<a href="homepage.jsp"><img src="images.png" alt="logo"
	...
	<div class="sidebar" style="margin-top: 0px;">
		<a class="active" href="homepage.jsp"><i class="fa fa-fw fa-home"></i>
			Home</a> <a href="Profile.jsp"><i class="fa fa-fw fa-user"></i>
